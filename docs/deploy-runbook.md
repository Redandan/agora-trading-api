...
- Top-level Java package boundary stays explicit: trading-owned `com.agora.*` packages are allowlisted, and marketplace-style packages are rejected by local verification.
