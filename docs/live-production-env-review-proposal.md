...
dryRunFlags=true
bundle_blockers=["LIVE_READINESS_NOT_READY","BACKGROUND_AUTOMATION_REVIEW","RUNTIME_EVIDENCE_CONFIG_DISABLED","RUNTIME_EVIDENCE_NO_SHADOW_INTENT","SIGNAL_POLICY_REVIEW_GAPS","TINY_LIVE_LOSS_HARD_STOP","TINY_LIVE_ROLLOUT_NOT_READY","DEPLOYED_RUNTIME_NOT_CURRENT"]
