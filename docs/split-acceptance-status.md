...
- The current local handoff batch is not deployed evidence until it is pushed,
  ...
  Current source now requires 40 representative MCP parity tools after adding
  the read-only BTC_BASE semantics/profit report, Binance range backfill, and
  golden-truth verification surfaces;
