...
- Market-signal risk-card scheduling is disabled and dry-run by default in the tracked template, including `MARKET_SIGNAL_RISK_CARD_ENABLED=false` and `MARKET_SIGNAL_RISK_CARD_DRY_RUN=true`.
