...
13. Batches 4A through 4H removed 111 additional unreferenced legacy classes,
    ...
    configuration bindings and repository interfaces (12,117 source lines).
    They had no controller, MCP, scheduler, event, interface-injection, or
    strategy-registry entry; configuration binding was removed only with its
    last consumer. No runtime catalog, strategy adapter, OCO/Grid path, active
...
14. Batch 5A removed 27 more unreachable Java files and 4,280
