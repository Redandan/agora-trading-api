#!/usr/bin/env python3
"""Deterministic pre-economic and matched-capital BLS Employment Situation release-day screen."""
...
EXPERIMENT_ID = "btc-bls-employment-situation-scheduled-release-day-risk-veto-historical-v1"
HYPOTHESIS_ID = "btc-bls-employment-situation-scheduled-release-day-risk-veto-v1"
EXPECTED_MANIFEST_TYPE = (
    "BTC_BLS_EMPLOYMENT_SITUATION_SCHEDULED_RELEASE_DAY_RISK_VETO_HISTORICAL_MANIFEST_V1"
)
EXPECTED_BTC_SHA256 = "e436a5a2b093365886464dd3e471cc5cd55c54bd2c06ceaa898ac218c45436dd"
EXPECTED_BTC_ROWS = 52_608
EXPECTED_PRIOR_SHA256 = "87411465603c9c7bea4f3adb4bec3161827cce4b6e3ab6b6d9617d163166af4f"
EXPECTED_CALENDAR_SHA256 = "899c286c952c8a79c04336bd00852e0c81024a015ee20ec9ccbd644b501468d0"
EXPECTED_HYPOTHESIS_SHA256 = "fe74404190c8311e7cdab08b9e95bc2cb52ddd5ca3cd36cae0023e2e1d7c073a"
...
EXPECTED_SOURCE_PATHS = {
    "FROZEN_DIRECT_BLS_EMPLOYMENT_SITUATION_PRE_ECONOMIC_AND_ECONOMIC_RUNNER": "research/btc_bls_employment_situation_scheduled_release_day_risk_veto_historical.py",
    "FROZEN_CPI_EVENT_RUNNER_DESIGN_REFERENCE": "research/btc_bls_cpi_scheduled_release_day_risk_veto_historical.py",
    ...
    "SEALED_PRIMARY_OFFICIAL_AND_ADVERSARIAL_PRIOR": "research_pipeline/examples/btc-bls-employment-situation-scheduled-release-day-risk-veto-primary-prior.v1.json",
    "FROZEN_PRE_OUTCOME_OFFICIAL_EVENT_CALENDAR": "research_pipeline/examples/btc-bls-employment-situation-release-dates-2020-2024.v1.json",
    "FROZEN_SCHEMA_VALID_PRE_OUTCOME_HYPOTHESIS": "research_pipeline/examples/btc-bls-employment-situation-scheduled-release-day-risk-veto-v1.hypothesis.json",
}
EXPECTED_SOURCE_HASHES = {
    "FROZEN_CPI_EVENT_RUNNER_DESIGN_REFERENCE": "34e2090962057b72659ae1f8cdc20e14a8f1021d99b28e4dce8a1160d3173a1a",
...
PREDICTIVE_GATES = (
    ...
    "exact_scheduled_employment_situation_event_count",
...
def predictive_evidence(
    ...
    expected_weekdays = {3, 4} if label == "design" else {4}
    ...
    minimum_total = 300 if label == "design" else 100
    minimum_control = 260 if label == "design" else 75
    ...
    gates = {
        ...
        "exact_scheduled_employment_situation_event_count": len(events) == expected_events,
    ...
    return {
        ...
        "statistics": {
            ...
            "scheduled_employment_situation_event_count": len(events),
...
def expected_predictive_policy() -> dict[str, Any]:
    return {
        "event": "COMPLETE_UTC_DAY_IS_FROZEN_BLS_EMPLOYMENT_SITUATION_RELEASE_DATE",
        ...
        "other_state": "SCHEDULED_BLS_EMPLOYMENT_SITUATION_RELEASE_DAY",
        "variants": 1,
...
def expected_economic_policy() -> dict[str, Any]:
    return {
        "target_exposure": "ZERO_FOR_COMPLETE_FROZEN_BLS_EMPLOYMENT_SITUATION_RELEASE_UTC_DAY_OTHERWISE_ONE",
...
def validate_manifest(manifest: dict[str, Any]) -> None:
    ...
    for binding in bindings:
        ...
        expected_hash = sha256(Path(__file__).resolve()) if role == "FROZEN_DIRECT_BLS_EMPLOYMENT_SITUATION_PRE_ECONOMIC_AND_ECONOMIC_RUNNER" else EXPECTED_SOURCE_HASHES[role]
...
def validate_inventory(bars: list[Any]) -> dict[str, int]:
    ...
    return {
        ...
        "scheduled_employment_situation_event_count": len(EVENT_DATES),
    }
...
def build_output(input_path: Path, manifest_path: Path) -> dict[str, Any]:
    ...
    kernel = base.economic_kernel.load_module("frozen_employment_situation_economic_reference", base.economic_kernel.BASE_RUNNER_SOURCE)
    parser = base.economic_kernel.load_module("frozen_employment_situation_h1_parser", base.economic_kernel.PARSER_SOURCE)
    ...
    return {
        "schema_version": "1",
        "document_type": "BTC_BLS_EMPLOYMENT_SITUATION_SCHEDULED_RELEASE_DAY_RISK_VETO_HISTORICAL_RESULT_V1",
        "experiment_id": EXPERIMENT_ID,
        "authorization": "RESEARCH_ONLY_NOT_SHADOW_PAPER_OR_LIVE",
        "status": "CANDIDATE_FROZEN_REPORTED_NOT_ACTIVATED" if passed else "NO_CANDIDATE_CLOSE_BLS_EMPLOYMENT_SITUATION_SCHEDULED_RELEASE_DAY_RISK_VETO_FAMILY",
        ...
        "oos_opened": False,
        "claim_boundary": "Historical preregistered Design and Validation only. A calendar association does not identify the Employment Situation release as the cause, and a pass is not independent OOS or activation authority.",
