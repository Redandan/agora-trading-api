...
$steps = @(
    ...
    New-Step -Name "governance-relaxation-preflight" -ScriptName "prepare_governance_relaxation_preflight_review_packet.ps1" -Arguments @("-ReviewLogPath", (& $out "governance-relaxation-review-packet-latest.log")) -OutputPath (& $out "governance-relaxation-preflight-review-packet-latest.log") -Ssh $false -Required $true
