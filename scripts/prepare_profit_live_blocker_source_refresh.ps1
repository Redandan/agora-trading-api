...
$steps = @(
    ...
    New-Step -Name "trailing-stop-dry-run-preflight" -ScriptName "prepare_trailing_stop_dry_run_preflight_review_packet.ps1" -Arguments @("-ReviewOutputDir", $ReviewOutputDir, "-DecisionLogPath", (& $out "trailing-stop-dry-run-operator-decision-packet-latest.log"), "-Symbol", $Symbol, "-StrategyId", "$StrategyId", "-MatrixMaxAgeMinutes", "$MatrixMaxAgeMinutes", "-RequireReady") -OutputPath (& $out "trailing-stop-dry-run-preflight-review-packet-latest.log") -Ssh $false -Required $true
    New-Step -Name "trailing-stop-dry-run-activation-review" -ScriptName "prepare_trailing_stop_dry_run_activation_review_packet_ssh.ps1" -Arguments @("-Symbol", $Symbol, "-RequireReady") -OutputPath (& $out "trailing-stop-dry-run-activation-review-packet-latest.log") -Ssh $true -Required $true
    New-Step -Name "trailing-stop-post-opt-in-readiness" -ScriptName "prepare_trailing_stop_post_opt_in_readiness_packet_ssh.ps1" -Arguments @("-SourceLog", (& $out "trailing-stop-dry-run-activation-review-packet-latest.log"), "-Symbol", $Symbol, "-ExpectedOptInStrategyId", "574", "-RequireReady") -OutputPath (& $out "trailing-stop-post-opt-in-readiness-packet-latest.log") -Ssh $false -Required $true
    New-Step -Name "trailing-stop-dry-run-observation-status" -ScriptName "prepare_trailing_stop_dry_run_observation_status_ssh.ps1" -Arguments @("-SourceLog", (& $out "trailing-stop-post-opt-in-readiness-packet-latest.log"), "-Symbol", $Symbol, "-ExpectedOptInStrategyId", "574", "-RequireReady") -OutputPath (& $out "trailing-stop-dry-run-observation-status-latest.log") -Ssh $false -Required $true
    ...
    New-Step -Name "profit-next-execution-blocker" -ScriptName "prepare_profit_next_execution_blocker_packet.ps1" -Arguments @("-PostOptInReadinessLogPath", (& $out "trailing-stop-post-opt-in-readiness-packet-latest.log"), "-TrailingObservationLogPath", (& $out "trailing-stop-dry-run-observation-status-latest.log"), "-Strategy574GovernanceLogPath", (& $out "strategy574-tiny-live-governance-operator-packet-latest.log"), "-DataFreshnessReadinessLogPath", (& $out "data-freshness-replay-evidence-readiness-refresh.log"), "-Symbol", $Symbol, "-StrategyId", "574", "-NoRefresh", "-RequireReady") -OutputPath (& $out "profit-next-execution-blocker-packet-latest.log") -Ssh $false -Required $true
    ...
    New-Step -Name "profit-operator-authorization-request" -ScriptName "prepare_profit_operator_authorization_request_packet.ps1" -Arguments @("-BoardLogPath", (& $out "profit-operator-next-action-board-latest.log"), "-AuditLogPath", (& $out "profit-live-blocker-audit-packet-latest.log"), "-MaxAgeMinutes", "$MatrixMaxAgeMinutes", "-RequireReady") -OutputPath (& $out "profit-operator-authorization-request-latest.log") -Ssh $false -Required $true
    New-Step -Name "profit-operator-quick-status" -ScriptName "prepare_profit_operator_quick_status.ps1" -Arguments @("-ReviewOutputDir", $ReviewOutputDir, "-NextExecutionLogPath", (& $out "profit-next-execution-blocker-packet-latest.log"), "-MatrixMaxAgeMinutes", "$MatrixMaxAgeMinutes", "-Symbol", $Symbol, "-StrategyId", "$StrategyId", "-RequireReady") -OutputPath (& $out "profit-operator-quick-status-latest.log") -Ssh $false -Required $true
)
