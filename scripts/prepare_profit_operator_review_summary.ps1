...
$summary = [pscustomobject]@{
    ...
    sourceMatrix = [string]$packet.sourceMatrix
    sourceMatrixMode = [string]$packet.sourceMatrixMode
    sourceMatrixOutputPath = if ($null -eq $packet.sourceMatrixOutputPath) { $null } else { [string]$packet.sourceMatrixOutputPath }
    sourceMatrixFreshness = $packet.sourceMatrixFreshness
...
Write-Host "profit_operator_review_summary_source_matrix_mode=$($summary.sourceMatrixMode)"
Write-Host "profit_operator_review_summary_freshness_status=$($summary.sourceMatrixFreshness.Status)"
Write-Host "profit_operator_review_summary_matrix_age_minutes=$($summary.sourceMatrixFreshness.AgeMinutes)"
