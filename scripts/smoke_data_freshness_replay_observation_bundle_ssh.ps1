...
$latestDataFreshnessRowTime = Get-Marker -Text $replayId.Text -Prefix "  latest_data_freshness_row_time="
$latestDataFreshnessRowAgeHours = Get-Marker -Text $replayId.Text -Prefix "  latest_data_freshness_row_age_hours="
$dataFreshnessRows1d = Get-Marker -Text $replayId.Text -Prefix "  data_freshness_rows_1d="
$dataFreshnessRows3d = Get-Marker -Text $replayId.Text -Prefix "  data_freshness_rows_3d="
$dataFreshnessRows7d = Get-Marker -Text $replayId.Text -Prefix "  data_freshness_rows_7d="
$dataFreshnessRows14d = Get-Marker -Text $replayId.Text -Prefix "  data_freshness_rows_14d="
$dataFreshnessRows30d = Get-Marker -Text $replayId.Text -Prefix "  data_freshness_rows_30d="
$dataFreshnessSampleGapStatus = Get-Marker -Text $replayId.Text -Prefix "  data_freshness_sample_gap_status="
