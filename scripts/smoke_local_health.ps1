...
try {
    ...
    $bootArguments = @(
        ...
        "--trading.signal-source.legacy-secondary-evaluator-enabled=false",
        "--trading.signal-source.legacy-secondary-allowed-strategy-ids=",
        "--trading.signal-source.legacy-secondary-max-notional-usdt=0",
        "--trading.tradingview.webhook.enabled=false",
        "--trading.tradingview.webhook.dry-run=true",
        "--trading.tradingview.webhook.secret=",
        "--trading.tradingview.webhook.allowed-symbols=BTCUSDT",
