...
print("  currentness_note=profit-candidate review does not run origin-delta; use smoke_profit_improvement_review_bundle_ssh.ps1 or prepare_profit_experiment_gate_ssh.ps1 before treating the evidence as current-post-deploy profit review input")
