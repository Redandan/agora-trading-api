...
foreach ($marker in @(
        ...
        "macro_watch_only_attention_rows",
        "strategy_scoped_attention_rows",
        "strategy_scoped_terminal_followup_rows",
        "strategy_scoped_no_terminal_followup_rows",
        "strategy_scoped_followup_classification",
        "strategy_scoped_attention_progression_recommendation",
