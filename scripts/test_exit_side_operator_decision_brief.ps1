...
foreach ($marker in @(
        ...
        "entry-filter-datafreshness-policy-out-of-scope",
        "trailing-stop-rollout",
        "strategy485-risk-reduction",
        "entry-filter-datafreshness-policy",
        "NOT_DECIDED_BY_EXIT_SIDE_BRIEF",
        "SEPARATE_EXIT_POLICY_REVIEW_NOT_LIVE",
        "SEPARATE_POSITION_RISK_REVIEW_NOT_MUTATION",
        "EXPLICITLY_OUT_OF_SCOPE_FOR_EXIT_SIDE_REVIEW",
