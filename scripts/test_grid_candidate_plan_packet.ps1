...
foreach ($marker in @(
        ...
        "GRID_CANDIDATE_PLAN_TREND_REVIEW_REQUIRED_NOT_OPEN_APPROVAL",
        ...
        "candidateTrendRegimeSource",
        "candidateTrendRegimeNote",
        "candidate replay trend review is separate from MCP trendGate clearance",
        "entryReferencePrice",
        "candidateLower",
        "candidateUpper",
