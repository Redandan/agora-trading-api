...
foreach ($marker in @(
        ...
        "separate trend-regime override is not required",
        "remainingExecutionBlockers",
        "bundleBlockers",
        "capitalHardBlockers",
        "envReviewBlockers",
        "createReviewBlockers",
        "coveredCreateReviewBlockers",
        "uncoveredCreateReviewBlockers",
        "grid_open_operator_authorization_request_covered_create_review_blockers",
        "grid_open_operator_authorization_request_uncovered_create_review_blockers",
        ...
        "existing ACTIVE grid order path",
        "orderPathWillBeActivatedByPendingOkxEnablement",
