...
foreach ($marker in @(
        ...
        "grid_open_operator_trend_override_risk_envelope",
        ...
        "grid_open_operator_event_risk_override_risk_envelope",
        "eventRiskOverrideRiskEnvelope",
        "riskLevel",
        ...
        "grid_open_operator_combined_override_risk_envelope",
        ...
        "grid_open_operator_okx_grid_env_preflight_envelope",
        ...
        "requiredEnvDiff",
        "postEnvVerification",
        "TRADING_GRID_AUTO_REBALANCE_SCHEDULER_ENABLED=false for initial open review",
        "GRID_RECOVERY_ENABLED=false for initial open review",
        "OKX_EARN_TOPUP_ENABLED=false for initial open review",
