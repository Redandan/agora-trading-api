...
foreach ($pattern in @(
        ...
        "local_tradingview_btc_base_live_micro_armed",
        ...
        "local_tradingview_btc_base_max_exposure_usdt",
        "local_tradingview_btc_base_open_exposure_usdt",
        "local_tradingview_btc_base_exposure_after_order_usdt",
        "local_tradingview_btc_base_exposure_cap_available",
