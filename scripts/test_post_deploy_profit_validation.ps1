...
foreach ($marker in @(
        ...
        "Expand-MissingRequirement",
        "Convert-ToCanonicalMissingRequirement",
        "Add-MissingRequirement",
        "Get-RuntimeDeltaImpact",
        "SERVER_ENV_TEMPLATE_RUNTIME_CONFIG_NOT_DEPLOYED",
        "SPRING_APPLICATION_CONFIG_RUNTIME_NOT_DEPLOYED",
        "DATAFRESHNESS_REPLAY_CANDIDATE_ID_RUNTIME_NOT_DEPLOYED",
        "DATAFRESHNESS_SHADOW_REPLAY_RUNTIME_NOT_DEPLOYED",
