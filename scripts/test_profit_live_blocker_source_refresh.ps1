...
foreach ($marker in @(
        ...
        "trailing-stop-dry-run-preflight-review-packet-latest.log",
        "trailing-stop-dry-run-activation-review-packet-latest.log",
        "trailing-stop-post-opt-in-readiness-packet-latest.log",
        "trailing-stop-dry-run-observation-status-latest.log",
        ...
        "profit-operator-quick-status-latest.log",
...
foreach ($marker in @(
        "profit_live_blocker_source_refresh_step_count=28",
        "profit_live_blocker_source_refresh_ssh_step_count=10",
        "profit_live_blocker_source_refresh_local_step_count=18",
        ...
        '"name":"trailing-stop-dry-run-preflight"',
        '"name":"trailing-stop-dry-run-activation-review"',
        '"name":"trailing-stop-post-opt-in-readiness"',
        '"name":"trailing-stop-dry-run-observation-status"',
        '"name":"profit-next-execution-blocker"',
        '"name":"profit-live-blocker-audit"',
        '"name":"profit-operator-next-action-board"',
        '"name":"profit-operator-authorization-request"',
        '"name":"profit-operator-quick-status"',
        ...
        '"script":"prepare_trailing_stop_dry_run_preflight_review_packet.ps1","arguments":["-ReviewOutputDir"',
        '"-DecisionLogPath"',
        'trailing-stop-dry-run-operator-decision-packet-latest.log',
        'trailing-stop-dry-run-preflight-review-packet-latest.log',
        '"script":"prepare_trailing_stop_dry_run_activation_review_packet_ssh.ps1","arguments":["-Symbol","BTCUSDT","-RequireReady"]',
        '"script":"prepare_trailing_stop_post_opt_in_readiness_packet_ssh.ps1","arguments":["-SourceLog"',
        'trailing-stop-dry-run-activation-review-packet-latest.log',
        'trailing-stop-post-opt-in-readiness-packet-latest.log',
        '"script":"prepare_trailing_stop_dry_run_observation_status_ssh.ps1","arguments":["-SourceLog"',
        'trailing-stop-dry-run-observation-status-latest.log',
        '"script":"prepare_profit_next_execution_blocker_packet.ps1","arguments":["-PostOptInReadinessLogPath"',
        '"-TrailingObservationLogPath"',
        '"-Strategy574GovernanceLogPath"',
        '"-DataFreshnessReadinessLogPath"',
        'profit-next-execution-blocker-packet-latest.log',
        '"entryDedupHours":720',
        ...
        'profit-operator-next-action-board-latest.log',
        'profit-operator-authorization-request-latest.log',
        '"script":"prepare_profit_operator_quick_status.ps1","arguments":["-ReviewOutputDir"',
