...
foreach ($marker in @(
        ...
        "source_signal_missed_blocker",
        "signalMissedBlockerDecision",
        "profit_operator_signal_missed_blocker_decision",
...
foreach ($marker in @(
        ...
        "profit_operator_review_summary_source_matrix_mode",
...
try {
    ...
    foreach ($marker in @(
            ...
            "source_signal_missed_blocker=prepare_signal_missed_blocker_decision_brief_ssh.ps1 mode=NOT_COLLECTED_REUSED_MATRIX exitCode=0",
    ...
    foreach ($marker in @(
            ...
            "profit_operator_review_summary_source_matrix_mode=REUSED_OUTPUT_FILE",
