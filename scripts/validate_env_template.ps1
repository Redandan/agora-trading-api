...
try {
    ...
    foreach ($key in @("TRADING_MCP_KEY", "AGORA_MARKET_INTERNAL_API_KEY", "TRADING_INTERNAL_API_KEY", "SPRING_DATASOURCE_USERNAME", "SPRING_DATASOURCE_PASSWORD", "TRADING_OKX_API_KEY", "TRADING_OKX_SECRET_KEY", "TRADING_OKX_PASSPHRASE", "TRADING_BINANCE_API_KEY", "TRADING_BINANCE_SECRET_KEY", "TELEGRAM_BOT_TOKEN", "TELEGRAM_CHANNEL_ID", "GEMINI_API_KEY", "GROQ_API_KEY", "ANTHROPIC_API_KEY", "JINA_API_KEY", "TRADING_MARKET_DATA_COINALYZE_API_KEY", "EXTERNAL_COINGECKO_DEMO_API_KEY", "EXTERNAL_FRED_API_KEY", "EXTERNAL_ETHERSCAN_API_KEY", "EXTERNAL_ALCHEMY_API_KEY", "EXTERNAL_THEGRAPH_API_KEY", "EXCHANGE_RATE_COINMARKETCAP_API_KEY")) {
