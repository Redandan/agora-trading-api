...
try {
    ...
    Assert-RgNoMatch -Pattern "pending trading Flyway baseline|V10[0-9] migration|follow-up Flyway migration" -Paths @("src/main/java", "src/test/java", "README.md", "docs", "SPLIT_PROGRESS.md") -Description "schema comments and docs must not imply pre-baseline or legacy V10x migration state"
