...
try {
    ...
    foreach ($pattern in @("live-background-automation", "READ_ONLY", "background_automation_true", "high_risk_background_automation_true", "missing_background_automation_flags", "MISSING_BACKGROUND_AUTOMATION_FLAG", "BACKGROUND_AUTOMATION_REVIEW_BEFORE_LIVE", "NOT_READY_BACKGROUND_AUTOMATION_REVIEW", "OK_BACKGROUND_AUTOMATION_DISABLED", "TRADING_MARKET_DATA_MCP_EXTERNAL_BACKFILLS_ENABLED", "TRADING_AUTONOMOUS_DIGEST_TELEGRAM_ENABLED", "TRADING_LIVE_SIGNAL_RETRY_NOTIFICATION_ENABLED", "Assert-RemotePathSafe", "Assert-SshHostSafe", "read-only check complete")) {
