...
try {
    ...
    foreach ($pattern in @("TelegramServiceImpl", "ExecutionEventScheduler", "runtime ERROR lines present: count=2", "high-risk operation-like log lines present", "runtime-log-smoke-classification-test")) {
