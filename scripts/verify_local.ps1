...
try {
    ...
    foreach ($pattern in @("DEPLOYMENT_METADATA_ONLY", "metadata-only", "liveBundleDeployStatus", "liveBundleOriginStatus", "deployment_metadata_status", "origin_metadata_status", "DEPLOYED_RUNTIME_NOT_CURRENT", "live_review_packet_allowed=false", "bundle_verdict=NO_EVIDENCE_FOR_LIVE_REVIEW_METADATA_ONLY", "Assert-RemotePathSafe", "Assert-SshHostSafe", "tr -d", "bash -s")) {
