...
try {
    ...
    Assert-RgMatch -Pattern "BRANCH='\$Branch' bash deploy\.sh" -Paths @("scripts/deploy_ssh.ps1") -Description "deploy SSH wrapper passes the reviewed target branch into deploy.sh"
