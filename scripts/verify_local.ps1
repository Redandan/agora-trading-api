...
try {
    ...
    Assert-RgMatch -Pattern "getPolymarketRisk live external reads are disabled" -Paths @("src/main/java/com/agora/mcp/MarketDataMcpTools.java") -Description "market-data MCP Polymarket risk reads are guarded"
