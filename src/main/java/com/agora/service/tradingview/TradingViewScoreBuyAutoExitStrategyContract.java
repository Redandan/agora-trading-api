 ...
 *
 * <p>Owner alias 509 promotes this contract to the minimal LIVE runtime. The
 * frozen entry calculation is unchanged; only its mechanical OKX spot
 * execution and deterministic profit exit are enabled.</p>
 */
public final class TradingViewScoreBuyAutoExitStrategyContract {
    ...
    public static final String OWNER_ALIAS = "509";
    ...
    public static final String LIVE_EXECUTION_TIMING = "FIRST_AVAILABLE_AFTER_DAILY_CLOSE";
